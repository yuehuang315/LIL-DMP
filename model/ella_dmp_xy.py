...
# 'ur_long_demo1','ur_long_demo2','3d','ur_long_demo1','ur_long_demo2',
# 'ur_short_demo1','ur_short_demo2','ur_short_demo3','ur_short_demo4','ur_short_demo5',
# 'ur_short_demo6','ur_short_demo7','ur_short_demo8','ur_short_demo9','ur_short_demo10',
# 'ur_short_demo11','ur_short_demo12','ur_short_demo13','ur_short_demo14','ur_short_demo15',
# 'ur_short_demo16','ur_short_demo17','ur_short_demo18','3d','ur_long_demo1',
...
# files = ['B0','out1','out2','out3','out4','out5']
files = ['out_1','out_2','out_3','out_4','out_5','out_6','out_7','out_8','out_9','out_10']
...
model_x = ll.ELLA(d=100, k=30, base_learner=Ridge)
model_y = ll.ELLA(d=100, k=30, base_learner=Ridge)
model_z = ll.ELLA(d=100, k=30, base_learner=Ridge)
...
################### n_bfs = 1 ###########################
    for iii in range(3):
        ...
        y_track_opt, dy_track_opt, ddy_track_opt= dmps.rollout_opt(ella_opt[ii])
...
###########################################
for ii in range(task_num):
    print("imitate_task%d:" %ii, imitate_task[ii][1])
...
#     ax.plot(imitate_task[i][1][:, 0], imitate_task[i][1][:, 1], imitate_task[i][1][:,2], label='Imitate_Path%d' %(i+1))
#     # ax.plot(imitate_task[i][0][:, 0], imitate_task[i][0][:, 1], imitate_task[i][0][:,2], c='b')
#     # ax.plot(imitate_task[i][2][:, 0], imitate_task[i][2][:, 1], imitate_task[i][2][:,2], c='green')
    
# ax.scatter(task_sets[task_num-1][:, 0], task_sets[task_num-1][:, 1], task_sets[task_num-1][:, 2], c='gray', marker='x', label='Demo_Path')
# ax.plot(imitate_task[task_num-1][1][:, 0], imitate_task[task_num-1][1][:, 1], imitate_task[task_num-1][1][:,2], c='r', label='Imitate_Path10')
# # ax.plot(imitate_task[task_num-1][0][:, 0], imitate_task[task_num-1][0][:, 1], imitate_task[task_num-1][0][:,2], c='b', label='Generalize_Path1')
# # ax.plot(imitate_task[task_num-1][2][:, 0], imitate_task[task_num-1][2][:, 1], imitate_task[task_num-1][2][:,2], c='green', label='Generalize_Path2')
# ax.legend()
# plt.show()
...
# fig = plt.figure()
# ax = fig.gca(projection='3d')
# ax.scatter(task_sets[3][:, 0], task_sets[3][:, 1], task_sets[3][:, 2], c='gray', marker='x', label='Demo_Path')
# ax.plot(imitate_task[3][1][:, 0], imitate_task[3][1][:, 1], imitate_task[3][1][:,2], c='r', label='Imitate_Path')
# # ax.plot(imitate_task[i][0][:, 0], imitate_task[i][0][:, 1], imitate_task[i][0][:,2], c='b', label='Generalize_Path1')
# # ax.plot(imitate_task[i][2][:, 0], imitate_task[i][2][:, 1], imitate_task[i][2][:,2], c='b', label='Generalize_Path2')
# ax.legend()
...
# fig = plt.figure()
# ax = fig.gca(projection='3d')
# ax.scatter(task_sets[24][:, 0], task_sets[24][:, 1], task_sets[24][:, 2], c='gray', marker='x', label='Demo_Path')
# ax.plot(imitate_task[24][1][:, 0], imitate_task[24][1][:, 1], imitate_task[24][1][:,2], c='r', label='Imitate_Path')
# # ax.plot(imitate_task[i][0][:, 0], imitate_task[i][0][:, 1], imitate_task[i][0][:,2], c='b', label='Generalize_Path1')
# # ax.plot(imitate_task[i][2][:, 0], imitate_task[i][2][:, 1], imitate_task[i][2][:,2], c='b', label='Generalize_Path2')
# ax.legend()
...
# fig = plt.figure()
# ax = fig.gca(projection='3d')
# ax.scatter(task_sets[49][:, 0], task_sets[49][:, 1], task_sets[49][:, 2], c='gray', marker='x', label='Demo_Path')
# ax.plot(imitate_task[49][1][:, 0], imitate_task[49][1][:, 1], imitate_task[49][1][:,2], c='r', label='Imitate_Path')
# # ax.plot(imitate_task[i][0][:, 0], imitate_task[i][0][:, 1], imitate_task[i][0][:,2], c='b', label='Generalize_Path1')
# # ax.plot(imitate_task[i][2][:, 0], imitate_task[i][2][:, 1], imitate_task[i][2][:,2], c='b', label='Generalize_Path2')
# ax.legend()
